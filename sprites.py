...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.max_travel = random.randint(17, 30)
    ...
    def a_star_path(self):
        ...
        pos_x = math.floor(self.game.player.x/TILESIZE)
        pos_y = math.floor(self.game.player.y/TILESIZE)
        x = math.floor(self.rect.x/TILESIZE)
        y = math.floor(self.rect.y/TILESIZE)
        current_map[pos_x] = current_map[pos_x][:pos_y] + 'P' + current_map[pos_x][pos_y + 1:]
        current_map[y] = current_map[y][:x] + 'E' + current_map[y][x + 1:]
        print(pos_y)
